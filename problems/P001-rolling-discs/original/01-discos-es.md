<!--
Original Spanish text of Problemas/01-discos.md, preserved verbatim.
Only the two image paths were updated when the images moved to
../assets/figures/ during the migration of 2026-09-12. No prose was changed.
The English account is at ../README.md.
-->
...
![Problema](../assets/figures/problem-statement.png)
...
![SolProblema](../assets/figures/human-attempt.jpeg)
...
- **Asunción:** El sistema solo rota alrededor del eje de la varilla con velocidad angular $\omega$.
- **Planteamiento:**

$$\mathbf{L}_{\text{CM}} = I_{\parallel} \boldsymbol{\omega}$$

- **Cálculo de Inercia:** $I_{\parallel} = \frac{1}{2}m a^2 + \frac{1}{2}(4m)(2a)^2 = \frac{17}{2}m a^2$
- **Resultado Asumido:** $L_{\text{CM}} = \frac{17}{2}m a^2 \omega$
